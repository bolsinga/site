...
public struct Lookup {
  ...
  func showRank(artist: Artist) -> Music.Ranking {
    artistRankingMap[artist.id] ?? Music.Ranking.empty
  }

  func venueRank(venue: Venue) -> Music.Ranking {
    venueRankingMap[venue.id] ?? Music.Ranking.empty
  }
}
